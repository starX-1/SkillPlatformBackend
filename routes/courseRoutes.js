...
import { createCourse, getAllCourses, getCourseById, getCourseByUploader, updateCourse } from '../controllers/courseController.js';
...
router.get('/getCourseByUploader', protect, getCourseByUploader)
